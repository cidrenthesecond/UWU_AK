...
(library Library_1
	...
	(compDef "LM4889MA_NOPB" (originalName "LM4889MA_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "__SHUTDOWN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "BYPASS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "8" (pinName "VO2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "VO1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/lm4889.pdf")
		(attr "Height" "1.75 mm")
	)
