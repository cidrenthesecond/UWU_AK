...
//156121/1366866/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM4889MA_NOPB" (originalName "LM4889MA_NOPB")
	...
	(compDef "LM4889MA_NOPB" (originalName "LM4889MA_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "__SHUTDOWN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "BYPASS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "VO2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VDD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VO1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM4889MA_NOPB"))
		...
		(attr "Manufacturer_Part_Number" "LM4889MA/NOPB")
		(attr "Description" "1W AUDIO POWER AMP, LM4889MA")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/lm4889.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "LM4889MA_NOPB.stp")
